...
- [大模型语料专题数据](/document/2?doc_id=142)
- [数据索引](/document/2?doc_id=209)
...
| 名称 | 类型 | 必选 | 描述 |
| --- | --- | --- | --- |
| ts\_code | str | N | TS股票代码([格式说明](https://tushare.pro/document/2?doc_id=14)) |
| name | str | N | 名称 |
| market | str | N | 市场类别 （主板/创业板/科创板/CDR/北交所） |
| list\_status | str | N | 上市状态 L上市 D退市 P暂停上市 G 未交易，默认是L |
...
| list\_status | str | N | 上市状态 L上市 D退市 G过会未交易 P暂停上市 |
...
© 2026 Tushare [京ICP备2026021642号-2](https://beian.miit.gov.cn)
